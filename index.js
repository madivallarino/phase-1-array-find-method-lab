...
superbowlWin = (array) =>  {
    let yearResult;
    let object;
    return object = (array.find((element) => element.result === "W")).year
    // yearResult = object.year
    // return object
}
...
// let yearResult = superbowlWin

// superbowlWin = (array) => {array.forEach(object => object.find(element => element.result === "W"))}
// .find((element) => {element.result === "W"})}
console.log(superbowlWin(record))
